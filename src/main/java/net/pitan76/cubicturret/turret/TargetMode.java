...
import net.pitan76.mcpitanlib.midohra.entity.SpawnGroup;
...
public class TargetMode {
    ...
    public String name;
    public Function<EntityWrapper, Boolean> function;

    public TargetMode(String name, Function<EntityWrapper, Boolean> function) {
        this.name = name;
        this.function = function;
    }

    public TextComponent getTranslation() {
        return TextComponent.translatable("targetmode.cubicturret." + name);
    }

    public boolean isTarget(EntityWrapper entity) {
